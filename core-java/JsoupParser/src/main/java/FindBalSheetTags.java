...
public class FindBalSheetTags {
    public static void main(String[] args) throws IOException {
        ...
        File f = new File("C:\\Users\\Lenovo\\Desktop\\up latest docs\\Accounts_Bulk_Data-2020-02-08");
        ...
        for (File file : f.listFiles()) {
            ...
            br.write(file.getName()+","+regNumber+","+stsmtFor+","+stsmtForYr+","+accountants);
            br.newLine();
            br.close();
            fr.close();
        }
